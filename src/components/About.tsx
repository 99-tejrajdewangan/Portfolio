import profilePhoto from "@/assets/tej-about-cropped.png";
...
const About = () => {
  const highlights = [
    ...
    },
    {
      ...
      description: "Specialized in modern Node.js development with ExpressJS, Nest.js",
    },
    {
      icon: <Code className="w-6 h-6" />,
      title: "Full Stack Development",
      description: "Specialized in modern React.js, Next.js, Node.js development with MongoDB",
    },
    {
          ...
          <div className="space-y-6 sm:space-y-8 animate-slide-up">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-base sm:text-lg leading-relaxed">
                ...
                , a passionate frontend developer currently working{" "}
              ...
              <p className="hidden sm:block text-lg leading-relaxed">
                ...
                with{" "}
                <span className="text-primary">GenAI and ChatGPT, DeepSeek, Claude ai</span>,
                and I am currently using all AI Tools for development, Full Stack / MERN Stack
                Development.
              </p>
              ...
              <blockquote className="hidden sm:block border-l-4 border-primary pl-6 py-4 bg-primary/5 rounded-r-lg">
                ...
                <footer className="text-sm text-muted-foreground mt-2">
                  — Tejraj Dewangan, Frontend Developer
                </footer>
              </blockquote>
            </div>
