  ...
  const educationData = [
    {
      ...
      institution: "Pt. Ravishankar Shukla University, Raipur",
      period: "2021 - 2023",
      status: "Completed",
      location: "Raipur, Chhattisgarh",
      description:
        "Completed Masters in Computer Application Associate Degree Program in Software Engineering with focus on modern development practices, programming fundamentals, and software design principles.",
      highlights: [
    ...
    },
    {
      ...
      institution: "Durga College, Raipur",
      period: "2018 - 2021",
      status: "Completed",
      location: "Raipur, Chhattisgarh",
      description:
        "Completed Bachelors in Pre-Engineering with strong foundation in Mathematics, Programming, and Computer Application.",
      highlights: [
    ...
    },
    {
      ...
      institution: "Govt. Hr. Sec. School, Chhuiha",
      period: "2015 - 2017",
      status: "Completed",
      location: "Raipur, Chhattisgarh",
      description:
